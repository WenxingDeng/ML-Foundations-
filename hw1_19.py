...
# FileName: hw1_19
# Description: Modify your algorithm in Problem 18 to return w50 (the PLA vector after 50 updates) instead
# of ^w (the pocket vector) after 50 updates. Run the modified algorithm on D, and verify the
...
# versus frequency. Compare your result to the previous problem and briely discuss your findings.
